...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPay_demo:(NSString *)appidwx
                                mch_id:(NSString *)mch_id
                            order_name:(NSString *)order_name
                           order_price:(NSString *)order_price
                           receive_URL:(NSString *)receive_URL
                              trade_sn:(NSString *)trade_sn
{
...
//    NSString *orderno   = [NSString stringWithFormat:@"%ld",time(0)];
    ...
    [packageParams setObject: appidwx             forKey:@"appid"];       //开放平台appid
    ...
    [packageParams setObject: receive_URL        forKey:@"notify_url"];  //支付结果异步通知
    [packageParams setObject: [NSString stringWithFormat:@"%@",trade_sn]           forKey:@"out_trade_no"];//商户订单号
    ...
    if ( prePayid != nil) {
        ...
        [signParams setObject: appidwx        forKey:@"appid"];
...
-(NSString *)randomPassword{
    ...
    NSString *randomString = [NSString stringWithFormat:@"%.5f",random];
